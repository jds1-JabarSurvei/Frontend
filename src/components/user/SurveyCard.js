                        ...
                        <div className="col-3">
                            {
                                ...
                                <div className="dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby={id}>
                                        <li><span className="dropdown-item"><i class="far fa-edit dropdownMenuCard"></i> EDIT</span></li>
                                        <li onClick={ () => handleModal(`${id}`)}><span className="dropdown-item"><i class="far fa-trash-alt dropdownMenuCard"></i> DELETE</span></li>
                                    </ul>
                                </div> : ""
                            }
                        </div>
